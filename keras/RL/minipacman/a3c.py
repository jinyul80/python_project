...
parser.add_argument('--logdir', default='./log/a3c_log')
...
class Agent:
    ...
    def build_model(self):
        ...
        fc = Dense(128, activation='relu')(input)
...
class RunnerThread(threading.Thread):
    stop_flag = False
    global_episode = 1
    recently_avg_list = deque(maxlen=30)
    all_avg_list = []
...
def main():
    ...
    while not RunnerThread.stop_flag:
        ...
        if current_idx > save_idx:
            ...
            pylab.savefig("./save_graph/mini_pacman_a3c.png")
