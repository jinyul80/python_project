...
# x_train = resize(x_train, [50000, 64, 64, 3])
# x_test = resize(x_test, [10000, 64, 64, 3])
...
# model_name = 'cifar10_%s_model.{epoch:03d}.ckpt' % model_type
model_name = 'cifar10_%s_model.ckpt' % model_type
...
# if tf.train.checkpoint_exists(save_dir):
load_file = tf.train.latest_checkpoint(save_dir)
if load_file != None:
    print('Load weights :', load_file)
