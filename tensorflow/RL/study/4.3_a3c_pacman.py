...
parser.add_argument('--logdir', default='./log/4.3_a3c_pacman_log')
...
class Agent(threading.Thread):
    ...
    def print(self, reward, avg_reward, rTime):
        message = "Episode : {} , Agent(name={}, reward= {:.2f}, avg= {:.2f}) ({:.5f} sec)".format(self.local_episode,
    ...
    try:
        ...
        with tf.device("/cpu:0"):
            ...
            while not coord.should_stop():
                ...
                # 평균 300점 이상이면 종료
                if np.mean(Agent.global_reward_list) > 300:
                    coord.request_stop()
                    coord.join(thread_list)
